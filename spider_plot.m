...
%             'VerticalAlignment', 'middle');
        if ~(hh==1 && ii==length(radius)) % No pintamos el 5 del eje de la derecha para que el texto de esa etiqueta no lo tape parcialmente
            text(x_isocurves(ii, hh), y_isocurves(ii, hh), sprintf('    %d', row_axis_labels(ii)),...
                'Units', 'Data',...
                'Color', 'k',...
                'FontSize', 30,...
                'HorizontalAlignment', 'center',...
...
% Axis limits
axis square;
axes_limit = axes_limit + 0.1; % Para hacer mas grande la superficie y que encaje el texto
